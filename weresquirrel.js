//weresquirrel example from eloquent js. 
...
//example to show, how to call property name which is a string, or a number:

var descriptions = {

	work: 'went to work',
	'touched tree': 'trouch a tree', //property name is a string
	'4545': 'number valid' // property name is number
};

console.log(descriptions['touched tree']);
console.log(descriptions['4545']);
