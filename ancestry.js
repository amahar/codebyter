...
console.log(ANCESTRY_FILE);//outputs as a string
console.log(ANCESTRY_FILE.length);// outputs the length of string - 5189
var ancestryObject = JSON.parse(ANCESTRY_FILE);//converts JSON string/text into an object
console.log(ancestryObject);// outputs the data as an array of objects
console.log(ancestryObject.length);



//return people whose ages were between 1900 and 1924

//this is to show what the filter method does internally: source eloquent - chapter high order function
// function filter(people,age){

//     personFound = [];
//   for(i=0;i<people.length;i++){
//     if(age(people[i])){

//       personFound.push(people[i]);
...
// console.log(filter(ancestryObject, function(person){
...
var overNinety = ancestryObject.filter(function(person){
...
//using reduce to retrieve the oldest person in the ancestry
console.log(ancestryObject.reduce(function(a, b) {
