...
function checkCor (e) {
	...
	var outputOffsetWH = "Current value of offsetWidth: " + n + ", Current value of offsetHeight" + m;
	var outputOffsets = "Current value of offsetLeft: " + o + ", Current value of offsetTop:" + p;
	var outputPage = "Current value of pageX: " + q + ", Current value of pageY:" + r;
	var outputClient = "Current value of clientX: " + u + ", Current value of clientY:" + x;
	var outputScreen = "Current value of screenX: " + y + ", Current value of screenY:" + z;

	document.getElementById('show-cordinates').innerHTML = outputOffsetWH + "<br>" + outputOffsets + "<br>" + 
															outputPage + "<br>" + outputClient + "<br>" + outputScreen; 
}